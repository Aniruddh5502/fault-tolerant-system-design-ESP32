...
[OK] Corrupted ota_0
>>> Press ENTER after pressing the EN/RST button (without BOOT) to reboot 
the board...
[MON] ets Jul 29 2019 12:21:46
[MON] rst:0x1 (POWERON_RESET),boot:0x13 (SPI_FAST_FLASH_BOOT)
[MON] configsip: 0, SPIWP:0xee
...
[INFO] ota_0 corruption handled successfully

==================================================
=== TEST: Corrupt ota_1 ===
==================================================

[TEST] Prepare to corrupt ota_1 (offset 0x150000)
>>> MANUAL STEP: Press and HOLD the BOOT button.
>>> While holding BOOT, press and RELEASE the EN/RST button.
>>> Keep holding BOOT until you see 'Connecting...' in the output.
[MON] ets Jul 29 2019 12:21:46
[MON] rst:0x1 (POWERON_RESET),boot:0x13 (SPI_FAST_FLASH_BOOT)
[MON] configsip: 0, SPIWP:0xee the EN/RST button (without BOOT) to reboot the board...
[MON] clk_drv:0x00,q_drv:0x00,d_drv:0x00,cs0_drv:0x00,hd_drv:0x00,wp_drv:0x00
[MON] mode:DIO, clock div:1
[MON] load:0x3fff0030,len:4640
[MON] load:0x40078000,len:15620
...
[MON] load:0x40080400,len:3164
[MON] entry 0x4008059c
[MON] E (30) esp_image: image at 0x150000 has invalid magic byte (nothing flashed here?)
[MON] E (30) boot: OTA app partition slot 1 is not bootable
[MON] E (139) esp_core_dump_x+͡: No core dump partition found!
[MON] E (139) esp_core_dump_flash: No
[MON] -----------------------------------------------------------------------------
[MON] FIRMWARE : ->       void setup running.
[MON] -----------------------------------------------------------------------------
[MON] E (1018) task_wdt: esp_task_wdt_init(517): TWDT already initialized
...
[MON] [INFO]       Scanning all partitions.
[MON] [INFO]       ota_0 is VALID
[MON] [ERROR]      ota_1 is INVALID (err: ESP_ERR_IMAGE_INVALID)
[MON] [INFO]       ota_2 is VALID
[MON] [INFO]       Using ota_2 as source for repairs
[MON] [INFO]       Attempting to repair invalid partition: ota_1
[MON] [INFO]       Repairing ota_1 <- ota_2 (size: 1310720 bytes)
[MON] <test>  VARIABLES OPERATIONS TEST  </test>
[MON] [TMR] Sensors: 12.3423, 19.3248, 32.4537, 43.4342, 12.2134, 54.4353
[MON] [RESULT]    VALIDATED   [RESULT]
[MON] <test>  MATH OPERATIONS TEST  </test>
[MON] [TMR] Sensors: 31.6671, -6.9824, 839.3576, 0.2244
[MON] [INFO]       Repair successful, ota_1 is now VALID
[INFO] ota_1 corruption handled successfully

==================================================
=== TEST: Corrupt ota_2 ===
==================================================

[TEST] Prepare to corrupt ota_2 (offset 0x290000)
>>> MANUAL STEP: Press and HOLD the BOOT button.
>>> While holding BOOT, press and RELEASE the EN/RST button.
>>> Keep holding BOOT until you see 'Connecting...' in the output.
>>> Press ENTER to continue...
...
[MON] [INFO]       ota_0 is VALID
[MON] [INFO]       ota_1 is VALID
[MON] [ERROR]      ota_2 is INVALID (err: ESP_ERR_IMAGE_INVALID)
[MON] [INFO]       Using ota_0 as source for repairs
[MON] [INFO]       Attempting to repair invalid partition: ota_2
[MON] [INFO]       Repairing ota_2 <- ota_0 (size: 1310720 bytes)
[MON] <test>  VARIABLES OPERATIONS TEST  </test>
[MON] [TMR] Sensors: 12.3423, 19.3248, 32.4537, 43.4342, 12.2134, 54.4353
[MON] [RESULT]    VALIDATED   [RESULT]
[MON] <test>  MATH OPERATIONS TEST  </test>
[MON] [TMR] Sensors: 31.6671, -6.9824, 839.3576, 0.2244
[MON] [INFO]       Repair successful, ota_2 is now VALID
[INFO] ota_2 corruption handled successfully
